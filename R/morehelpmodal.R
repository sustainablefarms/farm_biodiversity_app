...
out <- modalDialog(
  ...
  "Next describe the woodland patches on the farm:",
  ...
  tags$p(
    ...
    "estimates occupancy of 62 different bird species in remnant box gum grassy woodlands (BGGW) or planted woodland patches.",
  ...
  tags$p("For questions, help and bugs, please email Kassel on Kassel.Hingee@anu.edu.au"),
  title = "More Help",
  easyClose = TRUE,
  fade = TRUE
)
