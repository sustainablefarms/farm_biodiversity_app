...
########################################################
  ...
  tags$p('Noisy Miners are native honeyeaters whose abundance has increased markedly in the woodlands of south-eastern Australia in recent decades as a result of landscape changes brought about by clearing for agriculture and urbanisation. Small, grazed, remnant patches of eucalypt woodland without a shrubby midstorey suit the preferences of Noisy Miners perfectly.'),
