...
The model behind `r appname` has a year input that was used for statistical investigation, however this input has little influence and we it to 2018. The representative year used to estimate woody cover is much more influential of bird occupancy.
...
`r if (refisaverage){"an average woodland area."}else{"in Scenario 1."}`
Beneath is 
`r if (refisaverage){"the properties of the average woodland area."}else{"is the Scenario 1 information."}`
