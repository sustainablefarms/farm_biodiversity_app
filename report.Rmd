...
buildspeclatex <- function(specname){
  ...
  if (specname == "Western Gerygone"){
    credits <- paste("Words from \\url{http://birdswa.com.au/CEC/Handouts/Western%20Australian%20Gerygones.pdf}.",
      paste0("Image from \\url{", speciesinfo[specinforow, "url"], "}"))
  } else {
    credits <- paste0("Image and words from \\url{", speciesinfo[specinforow, "url"], "}")
  }
  out <- c(
    ...
    paste0("\"", speciesinfo[specinforow, "story"], "\""),
    credits,
    "\\end{minipage}"
    )
  return(out)
